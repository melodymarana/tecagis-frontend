...
(function (global, factory) {
    ...
    */
    ...
    var Navbar = {
        ...
        data: {
            dropdown: '.uk-navbar-appRouter > li',
            ...
            duration: 200,
            forceHeight: true,
            selMinHeight: '.uk-navbar-appRouter > li > a, .uk-navbar-item, .uk-navbar-toggle'
        },
                    ...
                    if (type === 'image' || source.match(/\.(jp(e)?g|png|gif|svg|webp)($|\?)/i)) {
                        ...
                        getImage(("https://img.youtube.com/vi/" + id + "/maxresdefault.jpg")).then(
                            function (ref) {
                                ...
                                // YouTube default error404Section thumb, fall back to low resolution
